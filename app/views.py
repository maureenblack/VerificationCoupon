...
def submit_form(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject=subject, message=message, from_email=settings.DEFAULT_FROM_EMAIL, recipient_list=['bruneltsafack@gmail.com', ]) #'galaxytech237@gmail.com', 'Denismartin342@gmail.com'
